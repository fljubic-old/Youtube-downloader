...
This one downloads the files in the highest resolution in mp4 format and
then gives you the option to convert those to mp3


I made this program just because I wanted to download a playlist from youtube, and convert it to mp3 so it would be in my music folder on mobile.
